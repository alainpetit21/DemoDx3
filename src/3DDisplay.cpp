...
/*==========================================*/
/*==========================================*/
void V3D_IPI_Nearest(CBMatrix& mat, VX* tri, ui32 nb, ui32 inter);
void V3D_IPI_Linear (CBMatrix& mat, VX* tri, ui32 nb, ui32 inter);
void V3D_IPI_Cosine (CBMatrix& mat, VX* tri, ui32 nb, ui32 inter);
void V3D_IPI_Cubic  (CBMatrix& mat, VX* tri, ui32 nb, ui32 inter);
void V3D_ID_Point   (VX* tri, TEXTURE* tex, ui32 nb);
void V3D_ID_Lines   (VX* tri, TEXTURE* tex, ui32 nb);
void V3D_ID_Flat    (VX* tri, TEXTURE* tex, ui32 nb);
void V3D_ID_Text    (VX* tri, TEXTURE* tex, ui32 nb);
void V3D_IDI_Point  (VX2* ver, TRI2* tri, TC2* p_texCoord, TEXTURE* tex, ui32 nbV, ui32 nbI);
void V3D_IDI_Lines  (VX2* ver, TRI2* tri, TC2* p_texCoord, TEXTURE* tex, ui32 nbV, ui32 nbI);
void V3D_IDI_Flat   (VX2* ver, TRI2* tri, TC2* p_texCoord, TEXTURE* tex, ui32 nbV, ui32 nbI);
void V3D_IDI_Text   (VX2* ver, TRI2* tri, TC2* p_texCoord, TEXTURE* tex, ui32 nbV, ui32 nbI);
void V3D_IPolyCalcPlane(VX* tri);
long V3D_IEatchunk  (PTFILE file, VX** p_vertex, VB* vbToFill);
/*==========================================*/
/*==========================================*/
extern IMAGE			bb;
...
/*==========================================*/
/*==========================================*/
ui16		m_dest[C3DW*C3DH*2];
DRAWER 		Drawer	= V3D_ID_Text;	
DRAWER_IB 	DrawerIB= V3D_IDI_Text;	
PROCESSOR 	Process	= 0;
/*==========================================*/
//Rasterize Data
/*==========================================*/
...
/*=========================*/
void V3D_LoadVB2(VB2** dst, VX2** p_vertex, i32 nb)
{
  (*dst)->m_start	= (*p_vertex);
  (*dst)->m_nb		= nb;
  (*p_vertex)		+= nb;
...
int cZ;
void
V3D_ProcessVB(CBMatrix& p_mat, VB* p_vb)
{
...
/*=========================*/
void
V3D_ProcessVB2(CBMatrix& p_mat, VB2* p_vb)
{
  i32 	ox
  , 	oy
  , 	oz;
...
/*=========================*/
void
V3D_ProcessMesh3DS(CBMatrix& p_mat, M3DS* p_mesh)
{
...
/*=========================*/
void
V3D_ProcessMeshMD2(CBMatrix& p_mat, MMD2* p_mesh)
{
...
/*=========================*/
void						
V3D_IPI_Nearest(CBMatrix& p_mat, VX* p_tri, ui32 p_nb, ui32 p_inter)
{
/*
	if(!Drawer){
		int toto= 23;
...
/*=========================*/
void						
V3D_IPI_Linear(CBMatrix& p_mat, VX* p_tri, ui32 p_nb, ui32 p_inter)
{
/*
	if(!Drawer){
		int toto= 23;
...
/*=========================*/
void						
V3D_IPI_Cosine(CBMatrix& p_mat, VX* p_tri, ui32 p_nb, ui32 p_inter)
{
/*
	if(!Drawer){
		int toto= 23;
...
/*=========================*/
void						
V3D_IPI_Cubic(CBMatrix& p_mat, VX* p_tri, ui32 p_nb, ui32 p_inter)
{
/*
	if(!Drawer){
		int toto= 23;
