...
void		GUI_Init();
void		GUI_Quit();
void		GUI_Open(string fileGuiCfg);
void		GUI_MapButtonPressed(uint pWnd, uint pCtl, EVENT_CALLBACK pFct);
void		GUI_Update();
void		GUI_PostMessage(GUI_MSG* p_msg);
GUI_MSG*	GUI_GetMessage();
void		GUI_ITrap();
/*=========================*/
/*=========================*/
#endif /*_GUI_H_*/